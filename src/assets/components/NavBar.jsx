...
const NavBar = () => {
  ...
  return (
    <nav className="bg-white/95 backdrop-blur-md shadow-xl fixed w-full top-0 z-50 overflow-hidden group font-inter border-b border-gray-200/50 safe-area-top">
      {/* Spotlight effect */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 relative z-10">
        <div className="flex justify-between items-center h-16 sm:h-18">
          ...
          <div className="flex-shrink-0">
            <a href="#" className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-zinc-950 via-cyan-900 to-gray-900 bg-clip-text text-transparent hover:from-cyan-700 hover:to-zinc-700 transition-all duration-300 tracking-tight">
              Portfolio
            </a>
          </div>
          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-2 lg:space-x-3">
              <a href="#home" className="text-gray-800 hover:text-cyan-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 bg-gray-100/60 hover:bg-none px-4 lg:px-7 py-2.5 lg:py-3 rounded-full text-sm lg:text-base font-semibold tracking-wide transition-all duration-300 hover:shadow-lg hover:scale-105 active:scale-95 flex items-center gap-2 group">
              ...
              <a href="#about" className="text-gray-800 hover:text-emerald-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 bg-gray-100/60 hover:bg-none px-4 lg:px-7 py-2.5 lg:py-3 rounded-full text-sm lg:text-base font-semibold tracking-wide transition-all duration-300 hover:shadow-lg hover:scale-105 active:scale-95 flex items-center gap-2 group">
              ...
              <a href="#skills" className="text-gray-800 hover:text-amber-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 bg-gray-100/60 hover:bg-none px-4 lg:px-7 py-2.5 lg:py-3 rounded-full text-sm lg:text-base font-semibold tracking-wide transition-all duration-300 hover:shadow-lg hover:scale-105 active:scale-95 flex items-center gap-2 group">
              ...
              <a href="#projects" className="text-gray-800 hover:text-rose-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 bg-gray-100/60 hover:bg-none px-4 lg:px-7 py-2.5 lg:py-3 rounded-full text-sm lg:text-base font-semibold tracking-wide transition-all duration-300 hover:shadow-lg hover:scale-105 active:scale-95 flex items-center gap-2 group">
                <svg className="w-4 h-4 lg:w-5 lg:h-5 transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-12" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20 6h-2.18c.11-.31.18-.65.18-1a2.996 2.996 0 0 0-5.5-1.65l-.5.67-.5-.68C10.96 2.54 10.05 2 9 2 7.34 2 6 3.34 6 5c0 .35.07.69.18 1H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-5-2c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM9 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1z"/>
                </svg>
                Projects
              </a>
              <a href="#contact" className="text-gray-800 hover:text-violet-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 bg-gray-100/60 hover:bg-none px-4 lg:px-7 py-2.5 lg:py-3 rounded-full text-sm lg:text-base font-semibold tracking-wide transition-all duration-300 hover:shadow-lg hover:scale-105 active:scale-95 flex items-center gap-2 group">
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full text-gray-700 hover:text-cyan-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 bg-gray-100/60 hover:bg-none focus:outline-none focus:ring-2 focus:ring-blue-200 transition-all duration-300 hover:shadow-lg active:scale-95 touch-manipulation"
            >
      ...
      <div className={`md:hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'} overflow-hidden safe-area-bottom`}>
        <div className="px-4 sm:px-6 pt-4 pb-6 space-y-2 bg-white/95 backdrop-blur-md shadow-lg border-t border-gray-200/50">
          <a
            href="#home"
            className="text-gray-800 hover:text-cyan-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 bg-gray-100/60 hover:bg-none block px-5 py-3.5 rounded-full text-base font-semibold tracking-wide transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg active:scale-95 flex items-center gap-3 group touch-manipulation"
            onClick={toggleMenu}
          >
          ...
          <a
            href="#about"
            className="text-gray-800 hover:text-emerald-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 bg-gray-100/60 hover:bg-none block px-5 py-3.5 rounded-full text-base font-semibold tracking-wide transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg active:scale-95 flex items-center gap-3 group touch-manipulation"
            onClick={toggleMenu}
          >
          ...
          <a
            href="#skills"
            className="text-gray-800 hover:text-amber-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 bg-gray-100/60 hover:bg-none block px-5 py-3.5 rounded-full text-base font-semibold tracking-wide transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg active:scale-95 flex items-center gap-3 group touch-manipulation"
            onClick={toggleMenu}
          >
          ...
          <a
            href="#projects"
            className="text-gray-800 hover:text-rose-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 bg-gray-100/60 hover:bg-none block px-5 py-3.5 rounded-full text-base font-semibold tracking-wide transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg active:scale-95 flex items-center gap-3 group touch-manipulation"
            onClick={toggleMenu}
          >
          ...
          <a
            href="#contact"
            className="text-gray-800 hover:text-violet-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 bg-gray-100/60 hover:bg-none block px-5 py-3.5 rounded-full text-base font-semibold tracking-wide transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg active:scale-95 flex items-center gap-3 group touch-manipulation"
            onClick={toggleMenu}
          >
