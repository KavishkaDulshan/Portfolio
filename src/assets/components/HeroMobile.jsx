...
const HeroMobile = ({
  ...
  return (
    <div className="lg:hidden">
      {/* Main Title */}
      <h1 className="mt-5 text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold leading-tight min-h-[1.2em] relative z-10 text-center px-2">
        <Typewriter 
          texts={[
            "Hello there!",
            "Glad To See You",
      ...
      <div className={`flex flex-col items-center transform transition-all ${getAnimationClass('duration-1000 delay-300')} ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} px-4`}>
      ...
      {/* Social Links - Mobile */}
      <div className={`flex gap-3 sm:gap-4 mt-4 sm:mt-6 transform transition-all ${getAnimationClass('duration-1000 delay-1000')} ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} relative z-20 justify-center`}>
        {/* WhatsApp */}
        <SocialWindow
          {...socialData.whatsapp}
      ...
      {/* CTA Buttons - Mobile */}
      <div className="flex flex-col items-center space-y-4 sm:space-y-6 px-4 mt-6">
