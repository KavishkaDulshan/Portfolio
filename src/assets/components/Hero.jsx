        ...
        <div className="min-h-screen flex flex-col justify-center gap-8 lg:gap-12">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            ...
            <div className={`hidden lg:flex flex-col items-center flex-shrink-0 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
              ...
              <div className={`flex gap-4 mt-6 transform transition-all duration-1000 delay-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} relative z-20`}>
                <SocialWindow
                  {...socialData.whatsapp}
                ...
                >
                  <a href="#" className="w-16 h-16 bg-gray-100/60 hover:bg-green-500 text-gray-700 hover:text-white rounded-full flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:scale-110 active:scale-95 group">
                ...
                <SocialWindow
                  ...
                  onMouseLeave={handleSocialLeave}
                >
                  <a href="#" className="w-16 h-16 bg-gray-100/60 hover:bg-blue-600 text-gray-700 hover:text-white rounded-full flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:scale-110 active:scale-95 group">
                    <svg className="w-8 h-8 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <SocialWindow
                  ...
                  onMouseLeave={handleSocialLeave}
                >
                  <a href="#" className="w-16 h-16 bg-gray-100/60 hover:bg-gray-800 text-gray-700 hover:text-white rounded-full flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:scale-110 active:scale-95 group">
                    <svg className="w-8 h-8 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className={`lg:hidden flex flex-col items-center transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            {/* Social Links under profile image - Mobile */}
            <div className={`flex gap-4 mt-6 transform transition-all duration-1000 delay-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} relative z-20`}>
              <SocialWindow
                {...socialData.whatsapp}
                isVisible={hoveredSocial === 'whatsapp'}
                ...
                onMouseLeave={handleSocialLeave}
              >
                <a href="#" className="w-14 h-14 bg-gray-100/60 hover:bg-green-500 text-gray-700 hover:text-white rounded-full flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:scale-110 active:scale-95 group">
              ...
              <SocialWindow
                ...
                onMouseLeave={handleSocialLeave}
              >
                <a href="#" className="w-14 h-14 bg-gray-100/60 hover:bg-blue-600 text-gray-700 hover:text-white rounded-full flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:scale-110 active:scale-95 group">
                  <svg className="w-7 h-7 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
              ...
              <SocialWindow
                ...
                onMouseLeave={handleSocialLeave}
              >
                <a href="#" className="w-14 h-14 bg-gray-100/60 hover:bg-gray-800 text-gray-700 hover:text-white rounded-full flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:scale-110 active:scale-95 group">
                  <svg className="w-7 h-7 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className={`flex justify-center mt-4 transform transition-all duration-1000 delay-1200 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} relative z-5`}>
              <video 
                ...
                muted 
                playsInline
                className="w-24 h-24 sm:w-28 sm:h-28 object-contain filter drop-shadow-lg transition-all duration-500 hover:scale-110"
              />
            </div>
          </div>
